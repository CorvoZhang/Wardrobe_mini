---
name: cypress-e2e-testing-setup
description: Sets up Cypress E2E testing environment. Invoke when configuring automated testing for full-stack applications or when needing to run end-to-end tests.
---
