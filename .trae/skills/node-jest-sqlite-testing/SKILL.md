---
name: "node-jest-sqlite-testing"
description: "Configures Node.js + Jest + SQLite testing environment. Invoke when setting up backend testing or resolving SQLITE_BUSY errors in test environments."
---
